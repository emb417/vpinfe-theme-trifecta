...
function updateWheelCarousel(view) {
    ...
    track.animate([{ transform: 'translateY(-50%)' }, { transform: translateValue(outgoingDelta) }], animationOptions);
    incomingTrack.animate([{ transform: translateValue(incomingStart) }, { transform: 'translateY(-50%)' }], animationOptions);
